...
namespace CMS.Backend.Controllers
{
    ...
    [ApiController]
    public class CategoriesProduct : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        // 5. Hàm khởi tạo (Constructor): "Tiêm" kết nối Database vào để sử dụng
        public CategoriesProduct(ApplicationDbContext context)
        {
            _context = context;
        }
        [HttpGet]
        ...
        {
            // Lấy dữ liệu từ bảng CategoriesProducts
            var posts = _context.CategoriesProducts
        ...
        public IActionResult GetDetail(int id)
        {
            ...
            var post = _context.CategoriesProducts
